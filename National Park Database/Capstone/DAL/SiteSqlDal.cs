...
namespace Capstone.DAL
{
    public class SiteSqlDal
    {
        ...
        //(ci <= rfd && co >= rtd) || //their reservation is inside of ours
        //(ci <= rfd && co <= rto && co >= rfd) || //reservations are overlapped by begininning of theirs
        //(ci >= rfd && co <= rtd) || //their reservation is over all of ours
        //(ci >= rfd && ci <= rfd && co >= rtd) //reservations are overlapped by ending of theirs
